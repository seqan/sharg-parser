...
which we hope cover most of the use cases, but you can always create your own validator (see section
...
\note If the validators below do not suit your needs, you can always create your own validator. See the
[SeqAn3 concept tutorial](https://docs.seqan.de/seqan/3-master-user/tutorial_concepts.html#autotoc_md142)
