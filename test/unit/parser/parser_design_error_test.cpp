...
TEST(parse_test, design_error)
{
    ...
    EXPECT_THROW(parser.add_option(option_value, 'i', "aint", "oh oh same id."), sharg::design_error);

    // long option
    sharg::parser parser2{"test_parser", 1, argv};
    parser2.add_option(option_value, 'i', "int", "this is an int option.");
    EXPECT_THROW(parser2.add_option(option_value, 'a', "int", "oh oh another id."), sharg::design_error);

    // empty identifier
    sharg::parser parser3{"test_parser", 1, argv};
    EXPECT_THROW(parser3.add_option(option_value, '\0', "", "oh oh all is empty."), sharg::design_error);

    bool true_value{true};

    // default true
    sharg::parser parser4{"test_parser", 1, argv};
    EXPECT_THROW(parser4.add_flag(true_value, 'i', "int", "oh oh default is true."), sharg::design_error);
    ...
    EXPECT_THROW(parser5.add_flag(flag_value, 'i', "int2", "oh oh another id."), sharg::design_error);

    // long flag
    sharg::parser parser6{"test_parser", 1, argv};
    parser6.add_flag(flag_value, 'i', "int", "this is an int option.");
    EXPECT_THROW(parser6.add_flag(flag_value, 'a', "int", "oh oh another id."), sharg::design_error);

    // empty identifier
    sharg::parser parser7{"test_parser", 1, argv};
    EXPECT_THROW(parser7.add_flag(flag_value, '\0', "", "oh oh another id."), sharg::design_error);
    ...
    EXPECT_THROW(parser9.add_option(option_value, 'h', "", "-h is bad."), sharg::design_error);
    EXPECT_THROW(parser9.add_option(option_value, '\0', "help", "help is bad."), sharg::design_error);
    EXPECT_THROW(parser9.add_option(option_value, '\0', "advanced-help", "advanced-help is bad"), sharg::design_error);
    EXPECT_THROW(parser9.add_option(option_value, '\0', "export-help", "export-help is bad"), sharg::design_error);

    // using one-letter long identifiers.
    sharg::parser parser10{"test_parser", 1, argv};
    EXPECT_THROW(parser10.add_option(option_value, 'y', "z", "long identifier is one letter"), sharg::design_error);
    EXPECT_THROW(parser10.add_flag(flag_value, 'y', "z", "long identifier is one letter"), sharg::design_error);

    // using non-printable characters
    sharg::parser parser11{"test_parser", 1, argv};
    EXPECT_THROW(parser11.add_option(option_value, '\t', "no\n", "tab and newline don't work!"), sharg::design_error);
    EXPECT_THROW(parser11.add_flag(flag_value, 'i', "no\n", "tab and newline don't work!"), sharg::design_error);
    EXPECT_THROW(parser11.add_flag(flag_value, 'a', "-no", "can't start long_id with a hyphen"), sharg::design_error);
}
